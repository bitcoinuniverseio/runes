...
export interface SizeAnalysisResult {
  ...
  standardLimitDifference: number; // positive = excess, negative = room
  policyRecommendation: string;
}

export function analyzeSize(scriptBytes: Uint8Array, payloadBytes: Uint8Array, pushes: number): SizeAnalysisResult {
